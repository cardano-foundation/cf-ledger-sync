...
>
> - [x] 1. Query the total ADA balance in a wallet address
> - [ ] [2. List of all respective UTXOs that compose a balance](https://cardano-foundation.github.io/cf-ledger-sync/use-case1/wallet02.mdx)
> - [ ] [3. Query your wallet's transaction history details](https://cardano-foundation.github.io/cf-ledger-sync/use-case1/wallet03.mdx)
> - [ ] [4. List a breakdown of all tokens, or NFTs, held in a wallet](https://cardano-foundation.github.io/cf-ledger-sync/use-case1/wallet04.mdx)
> - [ ] [5. Query the Asset/ NFT collection details belonging to a wallet address](https://cardano-foundation.github.io/cf-ledger-sync/use-case1/wallet05.mdx)
> - [ ] [6. Query Token metadata information](https://cardano-foundation.github.io/cf-ledger-sync/use-case1/wallet06.mdx)
> - [ ] [7. Query Active Stake Pools](https://cardano-foundation.github.io/cf-ledger-sync/use-case1/wallet07.mdx)
> - [ ] [8. Query Stake Pool detailed information](https://cardano-foundation.github.io/cf-ledger-sync/use-case1/wallet08.mdx)
> - [ ] [9. Query a stake pool's lifetime blocks](https://cardano-foundation.github.io/cf-ledger-sync/use-case1/wallet09.mdx)
> - [ ] [10. List the current dReps](https://cardano-foundation.github.io/cf-ledger-sync/use-case1/wallet10.mdx)
> - [ ] [11. List of "Active Governance Proposals" and number of votes](https://cardano-foundation.github.io/cf-ledger-sync/use-case1/wallet11.mdx)
> - [ ] [12. Query Smart contract transaction information](https://cardano-foundation.github.io/cf-ledger-sync/use-case1/wallet12.mdx)
