...
To make sure that the asset has been transferred from the smart contract address to your wallet, you can use the following query: [Breakdown list of all tokens or NFTs held in the wallet](../WalletQueries/wallet04).
