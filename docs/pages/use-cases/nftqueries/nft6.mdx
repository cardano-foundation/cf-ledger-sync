...
To make sure that the asset has been transferred from the smart contract address to your wallet, you can use the following query: [Breakdown list of all tokens or NFTs held in the wallet](https://github.com/johnnygreeney/cf-ledger-sync/blob/main/docs/pages/use-cases/WalletQueries/wallet04.mdx).

All of what just described is returned in the various [wallet and NFT queries](https://github.com/johnnygreeney/cf-ledger-sync/blob/main/docs/pages/use-cases.mdx) we discussed previously. 
