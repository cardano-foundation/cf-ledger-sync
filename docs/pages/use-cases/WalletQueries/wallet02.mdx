...
-  This [tx](/../../schema.md#tx) table holds general transaction information.
...
### Summary
- The query starts by looking at all transaction outputs from the [tx_out](/../../schema.md#tx_out) table.
- It verifies each output belongs to our specific address.
- It looks for matches in the [tx_in](/../../schema.md#tx_in) table to see if the output has been used as an input.
