...
-  [multi_asset](/../../schema.md#multi_asset) (alias ma) table stores information about the asset itself.
-  [tx](/../../schema.md#tx), ie. transaction data.
-  [tx_out](/../../schema.md#tx_out)stores transaction output data, where assets end up after a transaction.
-  [block](/../../schema.md#block) refers to blockchain block data. Transactions are grouped into blocks.
-  [ma_tx_out](/../../schema.md#ma_tx_out) table links multi-asset entries to transaction outputs.
-  [stake_address](/../../schema.md#stake_address) table stores information about wallet addresses.

### Main Query (SELECT...FROM)

- The query starts by selecting the desired columns from the [multi_asset](/../../schema.md#multi_asset) table.
...
- The main query uses a `LEFT JOIN` to combine the results of the two subqueries back to the main [multi_asset](/../../schema.md#multi_asset) table.
