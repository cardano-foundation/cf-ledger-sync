...
Another important feature Cardano Blockchain implements is governance. To read more about the roadmap [here](https://www.intersectmbo.org/roadmap), visit or catch up on the latest news on [Cardano Forum](https://forum.cardano.org/c/governance/140). This query provides a list of dReps currently registered on the system and additional information including:
