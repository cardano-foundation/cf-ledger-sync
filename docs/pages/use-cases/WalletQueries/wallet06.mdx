...
This part of the query specifies that we want to retrieve the `json` column from the [tx_metadata](/../../schema.md#tx_metadata) table.
...
The data is being retrieved from the [ma_tx_mint](/../../schema.md#ma_tx_mint) table, aliased as `mtm`.

The query joins the [tx_metadata](/../../schema.md#tx_metadata) table `tm`, using the `tx_id` (transaction id) column. The [multi_asset](/../../schema.md#multi_asset) table, alised `ma`, is joined with the `indent` column. using `ma.id = mtm.ident`.
...
- Joining the [ma_tx_mint](/../../schema.md#ma_tx_mint), [tx_metadata](/../../schema.md#tx_metadata), and [multi_asset](/../../schema.md#multi_asset) tables from Ledger Sync's database schema.
