...
>
> - [x] [1. Query the total ADA balance in a wallet address](blob/main/wallet.md#1-query-the-total-ada-balance-in-a-wallet-address) 
> - [x] [2. List of all respective UTXOs that compose a balance](blob/main/wallet.md#2-list-of-all-respective-utxos-that-compose-a-balance)
> - [x] [3. Query your wallet's transaction history details](/blob/main/wallet.md#3-query-your-wallets-transaction-history-details)
> - [x] [4. List a breakdown of all tokens, or NFTs, held in a wallet](/blob/main/wallet.md#4-list-a-breakdown-of-all-tokens-or-nfts-held-in-a-wallet)
> - [x] [5. Query the Asset/ NFT collection details belonging to a wallet address](/blob/main/wallet.md#5-query-the-asset-nft-collection-details-belonging-to-a-wallet-address)
> - [x] [6. Query Token metadata information](/blob/main/wallet.md#6-query-token-metadata-information)
> - [x] [7. Query Active Stake Pools](/blob/main/wallet.md#7-query-active-stake-pools)
> - [x] [8. Query Stake Pool detailed information](/blob/main/wallet.md#8-query-stake-pool-detailed-information)
> - [x] [9. Query a stake pool's lifetime blocks](/blob/main/wallet.md#9-query-a-stake-pools-lifetime-blocks)
> - [x] [10. List the current dReps](/blob/main/wallet.md#10-list-the-current-dreps)
> - [x] [11. List of "Active Governance Proposals" and number of votes](/blob/main/wallet.md#11-list-of-active-governance-proposals-and-number-of-votes)
> - [x] [12. Query Smart contract transaction information](/blob/main/wallet.md#12-query-smart-contract-transaction-information)
