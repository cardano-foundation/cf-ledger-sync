...
import org.cardanofoundation.ledgersync.aggregate.account.domain.AggregatedAddress;
...
public abstract class BlockAggregatorService<T> implements SyncServiceInstance<T> {
