...
maven-central-publish:
  ...
  ARG MAVEN_CENTRAL_GPG_KEY_ID
  ARG MAVEN_CENTRAL_GPG_PASSPHRASE
  ENV MAVEN_USERNAME $MAVEN_USERNAME
  ENV MAVEN_PASSWORD $MAVEN_PASSWORD
  ENV MAVEN_CENTRAL_GPG_PRIVATE_KEY $MAVEN_CENTRAL_GPG_PRIVATE_KEY
  ENV MAVEN_CENTRAL_GPG_KEY_ID $MAVEN_CENTRAL_GPG_KEY_ID
  ENV MAVEN_CENTRAL_GPG_PASSPHRASE $MAVEN_CENTRAL_GPG_PASSPHRASE
  RUN mkdir -p ~/.gradle && \
