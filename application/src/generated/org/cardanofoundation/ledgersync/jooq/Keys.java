...
public class Keys {
    ...
    public static final UniqueKey<TxBootstrapWitnessesRecord> TX_BOOTSTRAP_WITNESSES_PKEY = Internal.createUniqueKey(TxBootstrapWitnesses.TX_BOOTSTRAP_WITNESSES, DSL.name("tx_bootstrap_witnesses_pkey"), new TableField[] { TxBootstrapWitnesses.TX_BOOTSTRAP_WITNESSES.ID }, true);
    ...
    public static final UniqueKey<TxWitnessesRecord> TX_WITNESSES_PKEY = Internal.createUniqueKey(TxWitnesses.TX_WITNESSES, DSL.name("tx_witnesses_pkey"), new TableField[] { TxWitnesses.TX_WITNESSES.ID }, true);
