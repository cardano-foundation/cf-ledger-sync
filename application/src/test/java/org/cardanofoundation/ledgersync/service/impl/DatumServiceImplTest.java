...
class DatumServiceImplTest {
  ...
  void handleDatumWitnessOutputExist() {
    ...
    Set<org.cardanofoundation.ledgersync.consumercommon.entity.Datum> datums = new HashSet<>();
    datums.add(org.cardanofoundation.ledgersync.consumercommon.entity.Datum.builder()
  ...
  void handleDatumWithExistsData() {
    ...
    Map<String, org.cardanofoundation.ledgersync.consumercommon.entity.Datum> actualDatum = laclase.handleDatum(aggregatedTxs, txMap);
