...
import org.cardanofoundation.ledgersync.common.common.byron.ByronAddress;
import org.cardanofoundation.ledgersync.common.common.byron.ByronBlockCons;
import org.cardanofoundation.ledgersync.common.common.byron.ByronBlockExtraData;
import org.cardanofoundation.ledgersync.common.common.byron.ByronBlockHead;
import org.cardanofoundation.ledgersync.common.common.byron.ByronMainBlock;
import org.cardanofoundation.ledgersync.common.common.byron.ByronMainBody;
...
class ByronMainAggregatorServiceImplTest {
  ...
  void aggregateEmptyBlockTest() {
    ...
    Mockito.when(block.getBody()).thenReturn(byronMainBody);
    ...
    Mockito.when(slotId.getSlotId()).thenReturn(slotNo);
    ...
    ByronMainAggregatorServiceImpl victim =
        new ByronMainAggregatorServiceImpl(slotLeaderServiceImpl, blockDataService);
  ...
  void aggregateBlockWithTxTest() {
    ...
    ByronMainAggregatorServiceImpl victim =
        new ByronMainAggregatorServiceImpl(slotLeaderServiceImpl, blockDataServiceImpl);
    AggregatedBlock aggregatedBlock = victim.aggregateBlock(block);
    Assertions.assertEquals(byronEra, aggregatedBlock.getEra());
    Assertions.assertEquals(network, aggregatedBlock.getNetwork());
    Assertions.assertEquals(blockHash, aggregatedBlock.getHash());
