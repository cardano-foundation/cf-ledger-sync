...
CREATE INDEX IF NOT EXISTS idx_ls_stake_registration_addr_id ON ls_stake_registration USING btree (addr_id);
CREATE INDEX IF NOT EXISTS idx_ls_stake_registration_tx_id ON ls_stake_registration USING btree (tx_id);
...
CREATE INDEX IF NOT EXISTS idx_ls_stake_deregistration_addr_id ON ls_stake_deregistration USING btree (addr_id);
CREATE INDEX IF NOT EXISTS idx_ls_stake_deregistration_redeemer_id ON ls_stake_deregistration USING btree (redeemer_id);
CREATE INDEX IF NOT EXISTS idx_ls_stake_deregistration_tx_id ON ls_stake_deregistration USING btree (tx_id);
...
CREATE INDEX IF NOT EXISTS idx_ls_withdrawal_addr_id ON ls_withdrawal USING btree (addr_id);
CREATE INDEX IF NOT EXISTS idx_ls_withdrawal_redeemer_id ON ls_withdrawal USING btree (redeemer_id);
CREATE INDEX IF NOT EXISTS idx_ls_withdrawal_tx_id ON ls_withdrawal USING btree (tx_id);
CREATE INDEX IF NOT EXISTS idx_ls_delegation_active_epoch_no ON ls_delegation USING btree (active_epoch_no);
CREATE INDEX IF NOT EXISTS idx_ls_delegation_addr_id ON ls_delegation USING btree (addr_id);
CREATE INDEX IF NOT EXISTS idx_ls_delegation_pool_hash_id ON ls_delegation USING btree (pool_hash_id);
CREATE INDEX IF NOT EXISTS idx_ls_delegation_redeemer_id ON ls_delegation USING btree (redeemer_id);
CREATE INDEX IF NOT EXISTS idx_ls_delegation_tx_id ON ls_delegation USING btree (tx_id);
