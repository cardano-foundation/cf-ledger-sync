...
@Slf4j
public class StakeVoteRegDelegCertServiceImpl extends CertificateSyncService<StakeVoteRegDelegCert> {

    StakeDelegationServiceImpl stakeDelegationService;
    StakeRegistrationServiceImpl stakeRegistrationService;

    @Override
    public void handle(AggregatedBlock aggregatedBlock, StakeVoteRegDelegCert certificate, int certificateIdx, Tx tx,
