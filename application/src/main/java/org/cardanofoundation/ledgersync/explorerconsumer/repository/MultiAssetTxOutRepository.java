...
import org.cardanofoundation.ledgersync.explorerconsumer.projection.MaTxOutProjection;
...
public interface MultiAssetTxOutRepository extends JpaRepository<MaTxOut, Long> {
    ...
    @Query(
            "SELECT new org.cardanofoundation.ledgersync.explorerconsumer.projection.MaTxOutProjection("
