...
//    plutus_data = ; New
//    constr<plutus_data>
//  / { * plutus_data => plutus_data } //NOSONA
//  / [ * plutus_data ]
//            / big_int
//  / bounded_bytes
...
//    big_nint = #6.3(bounded_bytes) ; New
  ...
  static PlutusData deserialize(DataItem dataItem)
  ...
  static PlutusData deserialize(
      @NonNull byte[] serializedBytes) throws CborDeserializationException {
    try {
