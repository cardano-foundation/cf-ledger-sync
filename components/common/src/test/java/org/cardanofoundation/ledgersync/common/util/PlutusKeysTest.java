...
class PlutusKeysTest {
  ...
  void plutusV2() {
    ...
    Assertions.assertTrue(mapsEqual(expectMap, actual));
  }
  ...
  private <K, V> boolean mapsEqual(Map<K, V> map1, Map<K, V> map2) {
    if (map1 == map2) {
      return true;
    }
    ...
    for (Map.Entry<K, V> entry : map1.entrySet()) {
      ...
      if (!map2.containsKey(key) || !Objects.equals(value1, value2)) {
        return false;
      }
    }
