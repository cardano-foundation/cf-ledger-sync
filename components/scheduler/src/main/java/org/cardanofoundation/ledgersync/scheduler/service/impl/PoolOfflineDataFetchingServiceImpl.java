...
import org.cardanofoundation.ledgersync.scheduler.constant.JobConstants;
...
public class PoolOfflineDataFetchingServiceImpl implements PoolOfflineDataFetchingService {
  ...
  final PoolHashStorage poolHashStorage;
  ...
  public List<PoolData> fetchPoolOfflineData() {
    ...
    int start = 0;
    while (true) {
      List<PoolHashUrlProjection> poolHashUrlProjections = poolHashStorage.findPoolHashAndUrl(
